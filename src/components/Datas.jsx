      ...
      <Fade direction="up" triggerOnce>
        <div className="space-y-8">
          ...
          <p className="font-light text-gray-500 sm:text-lg ">
            Nous vous offrons une analyse approfondie de vos performances grâce
            à notre intégration innovante des données de votre tracker de
            dépenses énergétiques via votre téléphone, captées avec précision
            par votre montre connectée. <br />
            ...
            Transformez vos données en résultats concrets avec notre approche
            axée sur la précision et la personnalisation.
          </p>
        </div>
